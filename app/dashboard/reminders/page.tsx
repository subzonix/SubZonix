                ...
                <div className="flex items-center gap-2">
                    ...
                    {isEditing && title.includes("Instruction") ? (
                        <input
                            ...
                            className="bg-transparent border-b border-border outline-none text-[11px] font-black uppercase tracking-widest text-foreground w-40"
                        />
                    ) : (
            ...
            {isEditing ? (
                <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                    <textarea
                        ...
                        className="w-full h-40 p-4 text-[11px] bg-background text-foreground border border-border rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all outline-none resize-none font-medium leading-relaxed"
                        value={tempValue}
                        onChange={(e) => setTempValue(e.target.value)}
                        placeholder="Type your message here..."
                    />
                    <div className="flex flex-wrap gap-1.5 p-3  rounded-xl border border-border">
                ...
                <div
                    ...
                    className="p-5 bg-slate-50/50 dark:bg-slate-800/20 rounded-2xl border border-dashed border-border cursor-pointer group hover:border-indigo-400 dark:hover:border-indigo-500 transition-all min-h-[100px]"
                >
                        ...
                        <div className="space-y-6">
                            ...
                            {Object.keys(settings.instructions || {}).length < 8 && (
                                <button
                                    ...
                                    className="flex items-center justify-center p-4 border-2 border-dashed border-border rounded-2xl text-slate-400 hover:text-indigo-500 hover:border-indigo-200 transition-all group w-full"
                                >
                    ...
                    <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm">
                        ...
                        <div className="hidden md:block overflow-x-auto">
                            <table className="w-full text-left text-[11px]">
                                <thead className="bg-slate-50 dark:bg-slate-800/50 text-slate-500 font-bold uppercase tracking-wider border-b border-border">
                                    <tr>
                                ...
                                <tbody className="divide-y divide-border">
                                    ...
                                    >
                                        <td className="px-6 py-4 font-black text-foreground">Renewal Reminder</td>
                                    ...
                                    <tr
                                        ...
                                        className="group hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition cursor-pointer"
                                    >
                                        <td className="px-6 py-4 font-black text-foreground">Payment Pending Alert</td>
                                    ...
                                    <tr
                                        ...
                                        className="group hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition cursor-pointer"
                                    >
                                        <td className="px-6 py-4 font-black text-foreground">Order Receipt</td>
                                        <td className="px-6 py-4 text-xs font-bold text-emerald-500">Message</td>
                                    ...
                                    <tr
                                        ...
                                        className="group hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition cursor-pointer"
                                    >
                                        <td className="px-6 py-4 font-black text-foreground">Renewal Successful</td>
                                    ...
                                    {Object.entries(settings.instructions || {}).map(([key, val]: any) => (
                                        <tr
                                            ...
                                            className="group hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition cursor-pointer"
                                        >
                                            <td className="px-6 py-4 font-black text-foreground">{key}</td>
                ...
                {/* Edit Modal */}
                {
                    editingItem && (
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                            ...
                            <div className="relative w-full max-w-2xl bg-card border border-border rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                                ...
                                <div className="p-6 space-y-4">
                                    <textarea
                                        ...
                                        className="w-full h-64 p-5 text-[11px] bg-background text-foreground border border-border rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all outline-none resize-none font-medium leading-relaxed"
                                ...
                                <div className="p-6 border-t border-border bg-slate-50/30 dark:bg-slate-600/10 flex justify-between items-center gap-3">
                                    <div className="flex gap-2">
